    ...
    <div className='navContainer'>
      ...
      <div className='HamburgerMenu'>
        ...
        <ul className={click === true ? "dropActive dropdown" : "dropdown"}>
            ...
            <li className='list low' onClick={() => selected("Low Priority")}>Low</li>
            <li className='list medium' onClick={() => selected("Medium Priority")}>Medium</li>
            <li className='list high' onClick={() => selected("High Priority")}>High</li>
        </ul>
      </div>
    </div>
  )
